...
```yaml
{
  ...
  "repository": {
    "id": "GlacierEQ/anthropic-safety-monitor",
    "url": "https://github.com/GlacierEQ/anthropic-safety-monitor",
  ...
  "provenance": {
    ...
    "contract_digest": "a15dca757e2b7e78915943574aff7749c6ef36fa43f8723eff0de0394c1272f0"
  }
}
```
